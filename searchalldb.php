...
if (isset($_POST['query']) && !empty($_POST['query'])) {
    ...
    try {
        // On prépare la requête SQL en utilisant des paramètres liés pour éviter les injections SQL
        ...
        foreach ($results as &$result) {
            $result['titre'] = html_entity_decode($result['titre'], ENT_QUOTES | ENT_HTML5, 'UTF-8');
        }
